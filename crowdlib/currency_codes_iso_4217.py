...
This is used by the AMT class to verify that a currency code is valid.
'''

from __future__ import division, with_statement


currency_codes_iso_4217 = (
	...
	"ANG", # 532	2	Netherlands Antillean guilder	Caribbean Netherlands, Curaçao, Sint Maarten
